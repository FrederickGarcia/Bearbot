...
This module will contain event/handler/listener logic
It's a spaghetti right now
'''
...
class Spaghetti_Handler(object):
    '''
    This class determines what to do based off the message the bot 
    receives.
    '''
...
#Dictionary of server commands to their respective handling methods
handlers.update({'PRIVMSG': Spaghetti_Handler.user_message, 'PING': Spaghetti_Handler.pong}) 
...
class Response_Waiter(object):
    ...
    def __init__(self, **kwargs):
        pass
        ####DO shit here to start a new thread and wait
